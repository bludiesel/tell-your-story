...
| **Open** | `--t-open` 1100ms | The volume assembles around that page — boards swing out, the block gains thickness, the floor shadow spreads. `book-float-in` on `--ease-paper`. |
